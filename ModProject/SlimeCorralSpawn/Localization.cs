...
namespace SlimeCorralSpawn
{
    ...
    public static class Loc
    {
        ...
        private static readonly Dictionary<string, string[]> _t = new Dictionary<string, string[]>
        {
            ...
            { "sbt_hint_move",   new[]{
                "MOVER: apuntá una flecha con la mira, mantené [Click] y movés el mouse · PgUp/PgDn altura",
                "MOVE: aim an arrow with the crosshair, hold [Click] and move the mouse · PgUp/PgDn height",
                "移动：用准星对准一个箭头，按住[点击]并移动鼠标 · PgUp/PgDn 高度",
                "ПЕРЕМЕЩ.: наведите прицел на стрелку, зажмите [Клик] и двигайте мышь · PgUp/PgDn высота",
                "DÉPLACER : visez une flèche, maintenez [Clic] et bougez la souris · PgUp/PgDn hauteur" } },
            { "sbt_hint_free",   new[]{
                "LIBRE: apuntá y [Click] poner · rueda tamaño",
                "FREE: aim and [Click] to place · wheel = size",
                "自由：对准并[点击]放置 · 滚轮调整大小",
